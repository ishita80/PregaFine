...
export default function SecondTrimester() {
  return (
    <div>
      ...
      <PageNavigator w1='#week13To16' w2='#week17To20' w3='#week21To24' s1="13" e1="16" s2="17" e2="20" s3="21" e3="24" />
      ...
      <div className="fs-4 px-5 mx-5 w-75">
        ...
        <div id="week13To16" style={{ height: '55px' }}>

        </div>
        <p className="fw-semibold text-primary fs-2">Week 13 to 16</p>
        <div className="fs-4 fw-medium"> Weeks 13 and 14</div>
        ...
        <div className="fs-4 fw-medium"> Weeks 15</div>
        ...
        <div className="fs-4 fw-medium"> Weeks 16</div>
        ...
        <div id="week17To20" style={{ height: '55px' }}>

        </div>
        <p className="fw-semibold text-primary fs-2">Week 17 to 20</p>
        <div className="fs-4 fw-medium"> Weeks 17</div>
        ...
        <div className="fs-4 fw-medium"> Weeks 18</div>
        ...
        <div className="fs-4 fw-medium"> Weeks 19</div>
        ...
        <div className="fs-4 fw-medium"> Weeks 20</div>
        ...
        <div id="week21To24" style={{ height: '55px' }}>

        </div>
        <p className="fw-semibold text-primary fs-2">Week 21 to 24</p>
        <div className="fs-4 fw-medium"> Weeks 21</div>
        ...
        <div className="fs-4 fw-medium"> Weeks 22</div>
        ...
        <div className="fs-4 fw-medium"> Weeks 23</div>
        ...
        <div className="fs-4 fw-medium"> Weeks 24</div>
