...
export default function ThirdTrimester() {
  return (
    <div>
      ...
      <PageNavigator w1='#week25To28' w2='#week29To32' w3='#week33To36' s1="25" e1="28" s2="29" e2="32" s3="33" e3="36" />
      ...
      <div className="fs-4 px-5 mx-5 w-75">
        ...
        <div id="week25To28" style={{ height: '55px' }}>

        </div>
        <p className="fw-semibold text-primary fs-2">Week 25 to 28</p>
        <div className="fs-4 fw-medium"> Weeks 25 and 26</div>
        ...
        <div className="fs-4 fw-medium"> Weeks 27</div>
        ...
        <div className="fs-4 fw-medium"> Weeks 28</div>
        ...
        <div id="week29To32" style={{ height: '55px' }}>

        </div>
        <p className="fw-semibold text-primary fs-2">Week 29 to 32</p>
        <div className="fs-4 fw-medium"> Weeks 29</div>
        ...
        <div className="fs-4 fw-medium"> Weeks 30</div>
        ...
        <div className="fs-4 fw-medium"> Weeks 31</div>
        ...
        <div className="fs-4 fw-medium"> Weeks 32</div>
        ...
        <div id="week33To36" style={{ height: '55px' }}>

        </div>
        <p className="fw-semibold text-primary fs-2">Week 33 to 36</p>
        <div className="fs-4 fw-medium"> Weeks 33</div>
        ...
        <div className="fs-4 fw-medium"> Weeks 34</div>
        ...
        <div className="fs-4 fw-medium"> Weeks 35</div>
        ...
        <div className="fs-4 fw-medium"> Weeks 36</div>
